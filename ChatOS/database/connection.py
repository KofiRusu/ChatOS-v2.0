...
DATABASE_URL = os.environ.get(
    "CHATOS_DATABASE_URL",
    "postgresql://chatos:chatos@localhost:5432/chatos_learning"
)
...
def init_database(drop_existing: bool = False) -> None:
    ...
    """
    from ChatOS.database.models import Base
...
def _seed_default_data(engine: Engine) -> None:
    ...
    from ChatOS.database.models import KnowledgeDomain, DataSource
